...
// get type inputs by id

let type1 = document.getElementById('feature');
...
if(localStorage.myTasks != null){
 ...
 submitBtn.onclick = function(){
        taskType          = document.querySelector("input[name='type']:checked");
        let newTask = {
...
let moodBtn = document.getElementById('clear');
